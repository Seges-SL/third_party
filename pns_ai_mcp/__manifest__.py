...

{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'pns_ai_mcp/static/src/js/mcp_api_key_widget.js',
            'pns_ai_mcp/static/src/js/pns_html_readonly_widget.js',
            'pns_ai_mcp/static/src/js/mcp_user_tree.js',
            'pns_ai_mcp/static/src/js/ai_provider_tree.js',
            'pns_ai_mcp/static/src/js/mcp_log_tree.js',
            'pns_ai_mcp/static/src/js/mcp_log_form.js',
            'pns_ai_mcp/static/src/js/ai_agent_origin_filter.js',
            'pns_ai_mcp/static/src/js/mcp_json_compressed_widget.js',
            'pns_ai_mcp/static/src/js/mcp_context_tree.js',
            'pns_ai_mcp/static/src/js/mcp_context_action_buttons.js',
            'pns_ai_mcp/static/src/js/mcp_skill_action_buttons.js',
            'pns_ai_mcp/static/src/js/mcp_user_action_buttons.js',
            'pns_ai_mcp/static/src/js/ai_provider_action_buttons.js',
            'pns_ai_mcp/static/src/js/ai_agent_action_buttons.js',
            'pns_ai_mcp/static/src/js/whitelist_action_buttons.js',
            'pns_ai_mcp/static/src/js/external_server_action_buttons.js',
            'pns_ai_mcp/static/src/js/mcp_log_action_buttons.js',
            'pns_ai_mcp/static/src/js/safe_operation_action_buttons.js',
            # CSS: compact action menu cog for mcp_context list view (Odoo 17+)
            'pns_ai_mcp/static/src/css/mcp_context_list.css',
            'pns_ai_mcp/static/src/js/context_window_combo.js',
            'pns_ai_mcp/static/src/js/mcp_log_legend.js',
            'pns_ai_mcp/static/src/js/mcp_iso_datetime_widget.js',
            'pns_ai_mcp/static/src/js/mcp_agent_cache_widget.js',
            # QWeb templates (qweb key removed in Odoo 17+)
